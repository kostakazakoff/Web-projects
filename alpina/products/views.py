...
def create_article(request):
    ...
    if article_form.is_valid():
        ...
        # ingredients_total_cost = sum(
            # Decimal(article.product_01 * article.product_01_quantity),
            # Decimal(article.product_02 * article.product_02_quantity),
            # Decimal(article.product_03 * article.product_03_quantity),
        # )
