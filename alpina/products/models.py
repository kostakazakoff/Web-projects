...
class Ingredient(models.Model):
    ...
    title = models.CharField(max_length=200, blank=False, null=False, verbose_name='За изделие')
    product = models.CharField(max_length=100, blank=True, null=True, choices=products_choice, verbose_name='Продукт')
    quantity = models.DecimalField(decimal_places=3, max_digits=10, blank=True, null=True, default=0, verbose_name='Количество')
    unit = models.CharField(max_length=10, blank=True, null=True, choices=UNITS, verbose_name='Мярка')
